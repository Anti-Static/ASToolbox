...
var RadialPositionDuplicateCheck = group33.add("checkbox", undefined, undefined, {name: "RadialPositionDuplicateCheck"});
    RadialPositionDuplicateCheck.text = "Dup ";
...
var RadialPosition3DCheck = group33.add("checkbox", undefined, undefined, {name: "RadialPosition3DCheck"});
    RadialPosition3DCheck.text = "3D";
...
var statictext12 = group38.add("statictext", undefined, undefined, {name: "statictext12"});
    statictext12.text = "Col";
...
var statictext13 = GridRowGroup.add("statictext", undefined, undefined, {name: "statictext13"});
    statictext13.text = "Row";
...
var statictext14 = GridStepGroup.add("statictext", undefined, undefined, {name: "statictext14"});
    statictext14.text = "Step";
...
var statictext15 = group41.add("statictext", undefined, undefined, {name: "statictext15"});
    statictext15.text = "Col";
...
var statictext16 = GapRowGroup.add("statictext", undefined, undefined, {name: "statictext16"});
    statictext16.text = "Row";
...
var statictext17 = GapStepGroup.add("statictext", undefined, undefined, {name: "statictext17"});
    statictext17.text = "Step";
...
var statictext18 = group44.add("statictext", undefined, undefined, {name: "statictext18"});
    statictext18.text = "Distance";
...
var statictext26 = StringerPointsGroup.add("statictext", undefined, undefined, {name: "statictext26"});
    statictext26.text = "Points";
...
var statictext27 = group56.add("statictext", undefined, undefined, {name: "statictext27"});
    statictext27.text = "Num";
...
var statictext28 = tab4.add("statictext", undefined, undefined, {name: "statictext28", multiline: true});
    statictext28.text = "This work is provided \u0022as is,\u0022 without warranty of any kind, expressed or implied. In no event shall the author be held liable for any damages arising in any way from the use of this script.";
...
var statictext29 = tab4.add("statictext", undefined, undefined, {name: "statictext29", multiline: true});
    statictext29.text = "This work is licensed under a Creative Commons Attribution-ShareAlike 4.0 International License.";
...
var statictext30 = tab4.add("statictext", undefined, undefined, {name: "statictext30", multiline: true});
    statictext30.text = "Anti-Static name and logo ©2023 James Zelasko. All rights reserved.";
...
RadialPositionButton.onClick = function() {
  RadialPosition(Number(RadialPositionRadiusTextbox.text), Number(RadialPositionDuplicateTextbox.text), RadialPositionDuplicateCheck.value, RadialPositionRotateCheck.value, RadialPosition3DCheck.value);
}
...
function RadialPosition(rad, num, duplicate, rotate, threeD) {
  ...
  //var keyPress = ScriptUI.environment.keyboardState;
  //keyPress.altKey
  if(threeD) {
    rotate=true;
  }
  ...
  for (var k = 0; k < totalSlices; k++) {
    ...
    if (rotate) {
      if (l.property("Rotation").numKeys == 0) {
        if(threeD){
          l.property("Orientation").setValue([90, 180+sliceAngle * k, 0]);
        }else{
          l.property("Rotation").setValue(sliceAngle * k);
        }
      } else {
        if(threeD){
          l.property("Orientation").setValueAtTime(app.project.activeItem.time, [90, 180+sliceAngle * k, 0]);
        }else{
...
*/
  ...
  //'var r = Math.floor(Math.random()*letterArray.length);\rvar r2= Math.floor(Math.random()*letterArray.length);\rvar str = letterArray[r]+letterArray[r2]+Math.floor(random(100));\rstr'
